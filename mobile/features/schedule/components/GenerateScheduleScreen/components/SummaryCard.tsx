...
import { ScheduleSummary } from "@/src/models/schedule_summary.model";
import { SubSummary } from "@/src/models/sub_summary.model";
  ...
  return (
    <View style={s.summaryCard}>
      ...
      <View style={s.categoryList}>
        {summaries.map((cat, i) => {
          const subs = subSummaries.filter(
            (sub) => sub.summary_id === cat.id,
          );
          return (
            <View
              key={cat.id}
