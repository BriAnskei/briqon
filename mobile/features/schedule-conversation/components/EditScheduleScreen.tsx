...
import { formatDuration, formatTime12h } from "@/utils/TimeFormatter";
import { toneForIndex } from "../constants/tones";
import {} from "../hooks/useEditSchedule";
    ...
    <SafeAreaView style={s.root} edges={["top"]}>
      ...
      <View style={s.header}>
        ...
        >
          {isSubmitting ? (
            ...
            <Text style={s.doneBtnText}>{hasChanges ? "Apply changes" : "Done"}</Text>
          )}
        </TouchableOpacity>
      </View>
      ...
      >
        {items.map((item, index) => {
          ...
          const dur = formatDuration(item.start_time!, item.end_time!);
                ...
                >
                  <View style={s.cardTopRow}>
                    <View style={s.cardLeft}>
                      ...
                      />
                      <View style={s.tlBody}>
                        <Text style={[s.tlTitle, isPendingDelete && s.deletedTitle]}>
                          {item.activity}
                        </Text>
                        {dur ? (
                    ...
                    <View style={s.editInputInner}>
                      ...
                      <View style={s.editInputActions}>
                        ...
                        <TouchableOpacity
                          ...
                          onPress={() => {
                            if (state.status === "editing" && state.prompt.trim()) {
