...
import type { AppointmentType, BreakFrequency, EventType } from "@/type/NewScheduleTypes";
...
export const PERSONAL_STEP_LABELS = ["Time", "Appointments", "Meals", "Breaks", "Priority"];
