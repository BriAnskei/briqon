...
function DotMenu({
  ...
  return (
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onDismiss}>
      <TouchableOpacity style={s.menuOverlay} activeOpacity={1} onPress={onDismiss}>
        <View style={s.menuCard}>
          ...
          >
            ...
            <View style={s.menuItemBody}>
              ...
              <Text style={s.menuItemSub}>Disable every alarm in this schedule</Text>
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.75}
          >
            <View style={[s.menuIconWrap, { backgroundColor: Colors.dangerSoft }]}>
...
export default function HomeScreen() {
  ...
  const handleToggle = (id: string) =>
    setAlarms((prev) =>
      prev.map((a) => (a.id === id ? { ...a, alarmEnabled: !a.alarmEnabled } : a)),
    );
      ...
      >
        ...
        {hasSchedule ? (
          <View style={s.alarmList}>
            {alarms.map((alarm, i) => (
              <AlarmRow key={alarm.id} alarm={alarm} index={i} onToggle={handleToggle} />
            ))}
          </View>
        ) : (
