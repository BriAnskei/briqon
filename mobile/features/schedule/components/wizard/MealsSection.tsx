...
import type { MealPlacement, MealType } from "@/type/NewScheduleTypes";
import { Colors, Radius, Shadow } from "@/type/theme";
import { formatTime } from "@/utils/TimeFormatter";
import type { UseMealsStateType } from "../../hooks/form/useMeal";
            ...
            {MEAL_TYPES.map((t) => {
              ...
              return (
                <TouchableOpacity
                  ...
                  onPress={() => toggleMealType(t.key as MealType, t.defaultMins)}
                  activeOpacity={0.8}
                >
                  <Ionicons
                    name={t.icon as any}
            ...
            return (
              <View key={meal.id} style={s.mealCard}>
                <View style={s.mealCardHeader}>
                  ...
                  <Text style={s.mealDurationText}>{meal.durationMinutes} min</Text>
                </View>
                ...
                <Text style={[s.draftFieldLabel, { marginTop: 10 }]}>Placement</Text>
                  ...
                  <View style={{ marginTop: 10 }}>
                    ...
                    >
                      ...
                      <Text style={s.inputField}>
                        {meal.fixedTime ? formatTime(meal.fixedTime) : "Set time"}
                      </Text>
                    </TouchableOpacity>
