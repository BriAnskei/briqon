...
import type { UseEventItemsStateType } from "../../hooks/form/useEventItems";
...
export function EventItemsStep({
  ...
  return (
    <View style={s.body}>
      ...
      <Text style={s.sub}>Add key segments the AI should build the schedule around.</Text>
      ...
      <View style={s.section}>
        <View style={s.sectionHeader}>
          <View>
            ...
            <Text style={s.sectionSub}>Key segments the AI should build around</Text>
          </View>
          {!eventItemDraft.visible && (
            <TouchableOpacity style={s.addBtn} onPress={showDraft} activeOpacity={0.8}>
        ...
        {eventItemDraft.visible && (
          <View style={s.draftCard}>
            ...
            <View style={s.segmentRow}>
              <TouchableOpacity
                style={[s.segment, !eventItemDraft.isFixedTime && s.segmentActive]}
